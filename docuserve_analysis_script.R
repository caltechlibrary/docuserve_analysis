...
docuserve_data_all <- read_xlsx("./data/2021_docuserve_doc_del_requests.xlsx")
...
# export to csv files
write_csv(journal_abc, file = "./data/2021_docuserve_doc_del_journal_abc.csv")
write_csv(journal_count, file = "./data/2021_docuserve_doc_del_journal_count.csv")
